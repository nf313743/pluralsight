...
var ProductDetailComponent = /** @class */ (function () {
            ...
            if (params['id'] !== undefined) {
                if (params['id'] != '-1') {
                    _this.productService.getProduct(params['id'])
                        .subscribe(function (x) { return _this.product = x; }, function (errors) { return _this.handleErrors(errors); });
                }
                else {
    ...
    ProductDetailComponent.prototype.getCategories = function () {
        ...
        this.categoryService.getCategories()
            .subscribe(function (x) { return _this.categories = x; }, function (errors) { return _this.handleErrors(errors); });
    };
